...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void saveMessi()
    {
        ...
        Player messi = new Player( "Lionel Messi", bitmap? , "Lionel Andrés Messi", 34, 1.69, "Forward", "Paris Saint-Germain", 30, "Argentina", 758, 321, 80, "Career: Barcelona(2004-2021), PSG(2021-Today).",
